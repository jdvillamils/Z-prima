...
void TopAnalysis::define_histograms()
{
  ...
  hist_Topmass = new TH1F("hist_Topmass", "Top Invariant Mass; MTop;Events", 40, 0, 300);
  hist_Wmass = new TH1F("hist_Wmass", "W Invariant Mass; MW;Events", 40, 0, 200);
  hist_Mall = new TH1F("hist_Mall", "Z' Invariant Mass; MZ';Events", 40, 0, 3000);
}
...
void TopAnalysis::FillHistogramsGlobal( double m, float w , TString s)
{
  ...
  if (s.Contains("hist_Mall")) hist_Mall->Fill(m,w);
